...
export const projects: Project[] = [
  ...
  },
  {
    name: "KiloPulse",
    shortName: "KiloPulse",
    description: "A prepaid electricity tracker that turns remaining units into practical household insights.",
    problem: "Prepaid users see a unit balance, but often cannot tell how long it will last or what is consuming it.",
    solution: "A lightweight tracker that combines recharges, daily usage, estimates, and appliance-level context.",
    businessValue: "Helps households budget electricity and avoid unexpected outages.",
    features: ["Recharge logging", "Remaining kWh tracking", "Estimated days left", "Appliance insights", "Smart warnings"],
    tech: ["Flutter", "Dart", "Local Storage"],
    status: "Utility app concept",
    accent: "amber",
    future: ["Smart meter integration", "Tariff comparisons", "Shared household profiles"],
  },
  {
    name: "ShiftIQ",
    shortName: "ShiftIQ",
